...
//        frame = CGRectMake([UIScreen mainScreen].bounds.size.width - 70, 130, 40, 40);
    ...
    if (self) {
       ...
       self.backgroundColor=  [UIColor colorWithRed: 0.00 green: 0.00 blue: 0.00 alpha: 0.00];
        ...
        dispatch_async(dispatch_get_global_queue(0, 0), ^{
            NSData *imageData = [NSData dataWithContentsOfURL:[NSURL URLWithString:@"https://tracyfan.cn/hl.png"]];
